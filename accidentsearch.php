...
<body>
    ...
    $selectquery= "select * from personal_infor where p_status='accident' order by p_id DESC  limit {$offset},{$limit}";
...
for($i=1; $i<=$totpage; $i++){
 echo'<li class="page-item"><a style="font-size:2vh; padding:0px 3px; border:2px solid #ADD8E6; margin:0px 1px;" href="accident.php?pagination='.$i.'">'.$i.'</a></li>';
}
echo'</ul>';
include 'footer.php';
