...
<body>
    ...
    <form action="" class="mx-2 p-0" method="POST" enctype=multipart/form-data>
        ...
        <input type="text"  class="form-control mb-1" placeholder="Enter status"   value="<?php echo $res['info'];?>"  >
...
if(isset($_POST['submit'])){
    ...
    $inserting = "update personal_infor set founded_name='$fname', p_name='$name', p_location='$location', p_contact='$contact',   p_status='$stat' where p_id=$upda";
