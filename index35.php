...
<body>
    ...
    ?>
    <div class="center">
        <h1 class="text-white" style=" font-size:5vw; ">helperpk</h1>
        <p  class="text-white" style=" font-size:3vw; ">Hope,Help And Support For Lost One's</p>
      </div>
    </div>
     <div><br>
    ...
    ?>
         ...
         <div class="image_gallery"   data-aos="zoom-in"  data-aos-offset="300" data-aos-delay="50" data-aos-duration="2000">
             <div class="image_gallery1">
              <img class="img1"src="pic/masood.jpg"  alt="this picture is not supported in your browser"> <br> <br>
              <img class="img2" src="pic/missing1.jpg" alt="this picture is not supported in your browser"> <br> <br>
            </div> <br>
            <div class="image_gallery2"> 
              <img class="img3" src="pic/missing.jpg" alt="this picture is not supported in your browser"> <br> <br>
              <img class="img4" src="pic/missing3.jpg" alt="this picture is not supported in your browser"> <br> <br>
            </div><br>
            </div> <br> <br>
        </div > <br>
        <?php
