...
if(isset($_POST['submit'])){
    ...
    $inserting = "update personal_infor set founded_name='$fname', p_name='$name', p_location='$location', p_contact='$contact',   p_status='founded' where p_id=$upda";
