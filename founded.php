...
<form class="form-inline w-100" action="" method="POST">
...
if(isset($_POST['submit'])){
   $search=$_POST['search'];
$selectquery= "select * from personal_infor where p_name like '{$search}%' and p_status='Founded' ";
