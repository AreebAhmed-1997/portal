...
<body>
        <div class="div1"> 
           ...
           <div class="subdiv2">
            <p style="text-align:center;">Millions of people's life has changed, millions more awaiting your donation</p>
           </div><br>
            <div class="btn">
        ...
        <div  data-aos="zoom-out"  data-aos-offset="300" data-aos-delay="50" data-aos-duration="2000" class="theme">
            <div class="subtheme">
            <h1 class="theme0" style="font-family: 'Lobster', cursive; ">HELPERPK.COM</h1>
            <p class="theme1" style="font-family: 'Lobster', cursive;">A donation is a gift for charity, humanitarian aid, or to benefit a cause. A donation may take various forms, including money, alms, services, or goods such as clothing, toys, food, or vehicles. A donation may satisfy medical needs such as blood or organs for transplant.
              Charitable donations of goods or services are also called gifts in kind.</p>  <br><br>
              <div class="subtheme1">
             <a href="#themeses" class="theme3">SEND FEEDBACK</a>
              
            </div>
            </div>           
            <img  class="theme2"src="pic/walking.png" alt="this picture is not supported in your browser">
        ...
        <div class="introduction">
            <h1 style="text-align: center; font-family: 'Oswald', sans-serif; ">INTRODUCTION</h1>
                ...
                <p class="introduction1" data-aos="slide-up"  data-aos-offset="300" data-aos-delay="50" data-aos-duration="2000" >
                ...
                .<br> <br></p>
                   ...
                   <div class="div3">
                       <div class="subdiv3">
                    <div class="subdiv3_1">
                    <i class='fas fa-apple-alt' style='font-size:48px;color:#FFF'></i><br><br>
                    <p style="font-size: 17px; COLOR:#FFF; font-family: 'Playfair Display', serif;">125,000<br> DAILY DASTARKHAN (MONTHLY)</p><br><br>
                </div>
                <div  class="subdiv3_2">
                    <i class='fas fa-baby' style='font-size:48px;color:#fff'></i><br><br>
                    <p  style="font-size: 17px;COLOR:#FFF; font-family: 'Playfair Display', serif;">7,500<br>FAMILY ADOPTION (MONTHLY)</p><br><br>
                </div>
            </div>
            <div class="subdiv4">
                    <div class="subdiv3_3">
                    <i class="fa fa-heartbeat" style="font-size:48px;color:#fff"></i><br><br>    
                   <p style="font-size: 17px;COLOR:#FFF; font-family: 'Playfair Display', serif;">43,749<br> MEDICAL(MONTHLY)</p><br><br>
                </div>
                <div  class="subdiv3_4"> 
                   <i class='fas fa-graduation-cap' style='font-size:48px;color:#fff'></i><br><br>
                    <p style="font-size: 17px;COLOR:#FFF; font-family: 'Playfair Display', serif;">180,000 <br>EDUCATION (MONTHLY)</p>
                </div>
                </div>
            </div><br><br>
                <div class="div5"><br>
            ...
            <div class="subdiv5_1">
                <div class="subdiv5_4_1"><br>
                    <i class="fa fa-cutlery" style="font-size:48px;color:#6495ED"></i><br><br>
         ...
         <h1 style="text-align:center; color: #fff; font-family: 'Oswald', sans-serif;  ">  
            IMAGE GALLERY
         </h1>
         <div class="image_gallery"   data-aos="zoom-in"  data-aos-offset="300" data-aos-delay="50" data-aos-duration="2000">
            ...
            <div class="image_gallery2"> 
              <img class="img3" src="pic/miss3.jpg" alt="this picture is not supported in your browser"> <br> <br>
...
?>
    ...
    <input  class="btn  btn-success w-25" type="submit" name="submit" value="SEND"><br> <br>
         ...
         <table class="TABLE">
            ...
            <tr >
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;"><i class="fa fa-map-marker" style="font-size:20px"> A-25, Bahadurabad Chowrangi Karachi, Pakistan</i></td>
                <td></td>
            ...
            <tr>
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;"><i class="fa fa-globe" style="font-size:20px"> UAN: 111-729-526 (+0092-213) 4130786-90</i></td>
                <td></td>
            ...
            <tr>
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;"><i class="fa fa-mobile-phone" style="font-size:20px"> CELL: 92-311-1729526</i></td>
                <td></td>
            ...
            <tr>
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;">USA NO +1(716)941 7792</td>
            ...
            <tr>
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;">UK NO (+44)115 970 6256</td>
                <td></td>
            ...
            <tr>
                <td style="text-align: center; font-family: 'Playfair Display', serif; color:#C0C0C0;"><i class="fa fa-envelope" style="font-size:20px"> info@saylaniwelfare.com </i></td>
                <td style="text-align: center;"></td>
